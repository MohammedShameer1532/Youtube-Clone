...
const Sidebar = ({ isSidebarOpen, setCategory, fetchData, }) => {
  ...
  return (
    <div className={` ${isSidebarOpen ? "px-6 w-[90rem] sm:w-[40%] md:w-[75%] lg:w-[55%] xl:w-[25%]  h-[calc(100vh-6.625rem)] mt-6 md:mt-1 overflow-y-scroll overflow-x-hidden scrollbar-track-slate-600  scrollbar-none hover:scrollbar-thin" : "-translate-x-full ml-[-40%] sm:ml-[-20%]  md:ml-[-17%] lg:ml-[-16%] xl:ml-[-11%] 2xl:ml-[-10%] "} `}>
      <div>
